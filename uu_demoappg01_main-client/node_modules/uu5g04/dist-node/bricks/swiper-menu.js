...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Swiper.Menu"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'box'),
    classNames: {
      main: _bricksNs2.default.css("swiper-menu"),
      left: _bricksNs2.default.css("swiper-menu-left"),
      right: _bricksNs2.default.css("swiper-menu-right"),
      open: _bricksNs2.default.css("swiper-menu-open")
    },
    defaults: {
