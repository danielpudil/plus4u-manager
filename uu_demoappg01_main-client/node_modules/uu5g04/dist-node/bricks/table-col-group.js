...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Table.ColGroup"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'smallBox'),
    classNames: {
      main: _bricksNs2.default.css("table-col-group")
      //bg: 'uu5-common-bg'
    },
    defaults: {
  ...
  //@@viewOn:interface
  isColGroup: function isColGroup() {
    return true;
  },
