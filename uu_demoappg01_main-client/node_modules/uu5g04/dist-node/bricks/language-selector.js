...
var LanguageSelector = exports.LanguageSelector = (0, _createReactClass2.default)({
  ...
  _getItems: function _getItems() {
    ...
    Object.keys(this.state.languages).forEach(function (key, i) {
      ...
      if (key === this_.state.language) {
        cls = cls ? cls + ' ' + _this.getClassName('selected') : _this.getClassName('selected');
      }
  ...
  render: function render() {
    ...
    result = _react2.default.createElement(
      _dropdown2.default,
      _extends({}, this.getMainPropsToPass(), { label: this._getContent(this.props.headerMode), size: this.props.size, bgStyle: this.props.bgStyle || 'transparent', pullRight: this.props.pullRight, dropup: this.props.dropup }),
      this._getItems(),
