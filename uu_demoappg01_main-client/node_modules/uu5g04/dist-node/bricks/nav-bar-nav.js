...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("NavBar.Nav"),
    classNames: {
      main: _bricksNs2.default.css("nav-bar-nav nav navbar-nav"),
      align: _bricksNs2.default.css("nav-bar-nav-")
    },
    defaults: {
  ...
  //@@viewOn:propTypes
  propTypes: {
    aligned: _propTypes2.default.oneOf(['left', 'right']),
