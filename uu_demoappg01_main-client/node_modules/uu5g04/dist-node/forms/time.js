...
var Time = exports.Time = (0, _createReactClass2.default)({
  ...
  statics: {
    ...
    classNames: {
      ...
      secondsPickerWrapper: _formsNs2.default.css("time-seconds-picker-wrapper"),
  ...
  _increaseStart: function _increaseStart(id) {
    ...
    this._increaseTimeout = setTimeout(function () {
      _this2._increaseTimer = UU5.Environment.TimeManager.setInterval(function () {
  ...
  _decreaseStart: function _decreaseStart(id) {
    ...
    this._decreaseTimeout = setTimeout(function () {
      _this3._decreaseTimer = UU5.Environment.TimeManager.setInterval(function () {
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      this.props.seconds ? _react2.default.createElement(
        'div',
      ...
      this._isFormat12() && _react2.default.createElement(
        ...
        _react2.default.createElement(UU5.Bricks.ButtonSwitch, { className: this.getClassName("timePartSwitch"), ref_: function ref_(buttonSwitch) {
            ...
            content: _react2.default.createElement(UU5.Bricks.Icon, { icon: this.state.pm ? "mdi-chevron-right" : "mdi-chevron-left", className: "uu5-common-text " + (this.state.pm ? this.getClassName("iconPm") : this.getClassName("iconAm")) })
          } }),
        _react2.default.createElement(
          'span',
