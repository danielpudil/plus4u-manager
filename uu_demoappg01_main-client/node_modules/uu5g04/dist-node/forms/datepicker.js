  ...
  _getTextInputAttrs: function _getTextInputAttrs() {
    ...
    if (!this.isReadOnly() && !this.isDisabled()) {
      ...
      props.onTouchEnd = function (e) {
        e.preventDefault();
        if (new Date() - _this6._touchStart < UU5.Environment.holdTimeout) {
