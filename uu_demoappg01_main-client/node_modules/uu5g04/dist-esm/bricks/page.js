  ...
  _getType1() {
    ...
    return <Div {...this._getPropsToPass()}>
        ...
        <Row display={'flex'} className={this._getFullPageClass(true)}>
          <PageColumn {...this._getColumnProps(this.props.leftWrapperProps, this.getClassName('left'), LEFT, screenSize, !width.floatLeft)} width={width.widthLeft} minWidth={width.minWidthLeft} maxWidth={width.maxWidthLeft} openContent={this._getLeftContent().open} closedContent={this._getLeftContent().closed} ref_={left => this._pageLeft = left} block={!width.floatLeft} controlled={false} open={this.props.isLeftOpen} />
          <Div {...this._getColumnProps(this.props.contentWrapperProps, this.getClassName('content'), CONTENT)} mainAttrs={this._getContentAttrs(screenSize, width.widthContent)}>
            {this._getContentDiv()}
          </Div>
          <PageColumn {...this._getColumnProps(this.props.rightWrapperProps, this.getClassName('right'), RIGHT, screenSize, !width.floatRight)} width={width.widthRight} minWidth={width.minWidthRight} maxWidth={width.maxWidthRight} openContent={this._getRightContent().open} closedContent={this._getRightContent().closed} ref_={right => this._pageRight = right} block={!width.floatRight} right={true} controlled={false} open={this.props.isRightOpen && !this.props.isLeftOpen} />
        </Row>
