...
export const LanguageSelector = createReactClass({
  ...
  render() {
    ...
    //   );
    // } else {
    result = <Dropdown {...this.getMainPropsToPass()} label={this._getContent(this.props.headerMode)} size={this.props.size} bgStyle={this.props.bgStyle || 'transparent'} pullRight={this.props.pullRight} dropup={this.props.dropup}>
        {this._getItems()}
