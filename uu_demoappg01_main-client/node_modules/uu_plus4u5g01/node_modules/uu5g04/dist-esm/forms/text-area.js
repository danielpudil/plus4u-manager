...
export const TextArea = createReactClass({
  ...
  render: function () {
    ...
    return <div {...this._getInputAttrs()}>
        ...
        {this.getInputWrapper([<TextInput id={inputId} name={this.props.name || inputId} value={this.state.value} placeholder={this.props.placeholder} type={'textarea'} onChange={this.onChange} onBlur={this.onBlur} onFocus={this.onFocus} onKeyDown={this.onKeyDown} mainAttrs={this.props.inputAttrs} disabled={this.isDisabled() || this.isLoading()} readonly={this.isReadOnly()} loading={this.isLoading()} rows={this.props.rows} autoResize={this.props.autoResize} maxRows={this.props.maxRows} ref_={item => this._textInput = item} feedback={this.getFeedback()} />])}
      </div>;
  }
  //@@viewOn:render
});
