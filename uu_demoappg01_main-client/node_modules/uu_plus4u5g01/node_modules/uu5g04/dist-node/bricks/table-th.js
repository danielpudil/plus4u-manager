...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("Table.Th"),
    nestingLevelList: UU5.Environment.getNestingLevelList('boxCollection', 'inline'),
    classNames: {
      main: _bricksNs2.default.css("table-th uu5-common-text")
      //bg: 'uu5-common-bg'
    },
    defaults: {
  ...
  propTypes: {
    ...
    rowSpan: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string])
  },
