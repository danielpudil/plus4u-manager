...
require('./progress-bar-item.less');
...
exports.default = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _bricksNs2.default.name("ProgressBar.Item"),
    nestingLevelList: UU5.Environment.getNestingLevelList('bigBoxCollection', 'smallBox'),
    classNames: {
      main: _bricksNs2.default.css("progress-bar-item"),
      striped: _bricksNs2.default.css("progress-bar-item-striped"),
      active: _bricksNs2.default.css("progress-bar-item-active")
    },
    errors: {
  ...
  getProgressContent: function getProgressContent() {
    return this.state.content;
  },

  isStriped: function isStriped() {
  ...
  _checkProgress: function _checkProgress(newProgress) {
