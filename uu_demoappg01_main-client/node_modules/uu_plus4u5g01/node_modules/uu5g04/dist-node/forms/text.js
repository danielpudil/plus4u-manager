...
var Text = exports.Text = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _formsNs2.default.name("Text"),
    classNames: {
      main: _formsNs2.default.css("text")
    },
    errors: {
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      this.getInputWrapper([_react2.default.createElement(_textInput2.default, { id: inputId, name: this.props.name || inputId, value: this.state.value, placeholder: this.props.placeholder, type: this.props.password ? 'password' : this.props.type || 'text', onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown, mainAttrs: this.props.inputAttrs, disabled: this.isDisabled() || this.isLoading(), readonly: this.isReadOnly(), loading: this.isLoading(), ref_: function ref_(item) {
        ...
        }, feedback: this.getFeedback() }), this.state.autocompleteItems && _react2.default.createElement(
        _itemList2.default,
