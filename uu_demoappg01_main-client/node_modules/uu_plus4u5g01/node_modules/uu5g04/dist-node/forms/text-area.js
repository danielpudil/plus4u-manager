...
require('./text-area.less');

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TextArea = exports.TextArea = (0, _createReactClass2.default)({
  ...
  //@@viewOn:statics
  statics: {
    tagName: _formsNs2.default.name("TextArea"),
    classNames: {
      main: _formsNs2.default.css("text-area")
    },
    errors: {
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      this.getInputWrapper([_react2.default.createElement(_textInput2.default, { id: inputId, name: this.props.name || inputId, value: this.state.value, placeholder: this.props.placeholder, type: 'textarea', onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown, mainAttrs: this.props.inputAttrs, disabled: this.isDisabled() || this.isLoading(), readonly: this.isReadOnly(), loading: this.isLoading(), rows: this.props.rows, autoResize: this.props.autoResize, maxRows: this.props.maxRows, ref_: function ref_(item) {
