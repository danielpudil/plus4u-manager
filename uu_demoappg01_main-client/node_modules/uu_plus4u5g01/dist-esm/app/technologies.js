...
export const Technologies = createReactClass({
  ...
  _getRows() {
    ...
    if (Array.isArray(this.props.content)) {
      return this.props.content.map((row, i) => <UU5.Bricks.P className={this.getClassName().row} key={i} content={row} />);
    } else {
  ...
  render() {
    ...
    return <UU5.Bricks.Section {...this.getMainPropsToPass()} header={header} content={null} level={this.props.level || 4}>
