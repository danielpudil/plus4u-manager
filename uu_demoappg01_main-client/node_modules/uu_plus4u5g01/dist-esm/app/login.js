...
export const Login = createReactClass({
  ...
  //@@viewOn:mixins
  mixins: [UU5.Common.BaseMixin, UU5.Common.ElementaryMixin, UU5.Common.NestingLevelMixin, UU5.Common.LsiMixin, UU5.Common.IdentityMixin],
  //@@viewOff:mixins
  ...
  //@@viewOn:render
  render() {
    return this.getNestingLevel() && this.isNotAuthenticated() ? <UU5.Bricks.Div {...this.getMainPropsToPass()}>
          <UU5.Bricks.Div className={this.getClassName('text')}>
            <UU5.Bricks.P className={this.getClassName('loginText')} content={this.getLsiValue('loginText')} />
            <UU5.Bricks.P className={this.getClassName('registerText')} content={this.getLsiValue('registerText')} />
          </UU5.Bricks.Div>
          <UU5.Bricks.Div className={this.getClassName('buttons')}>
            <LoginButton className={this.getClassName('loginButton')} />
            <UU5.Bricks.Button className={this.getClassName('registerButton')} onClick={this._register} content={this.getLsiValue('registerButton')} />
          </UU5.Bricks.Div>
        </UU5.Bricks.Div> : null;
  }
  //@@viewOff:render
