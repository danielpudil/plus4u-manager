...
export const Page = createReactClass({
  ...
  _getLanguageSelector() {
    return <UU5.Bricks.LanguageSelector headerMode="code" bodyMode="label-code" noIndex pullRight displayedLanguages={this.props.displayedLanguages} className={this.getClassName('languageSelector')} />;
  },
  ...
  render() {
    ...
    return this.getNestingLevel() === 'page' ? <UU5.Bricks.Page {...this.getMainPropsToPass()} type={this.props.type || 1} fullPage={this.props.fullPage} topWrapperProps={topWrapperProps} bottomWrapperProps={bottomWrapperProps} leftWrapperProps={leftWrapperProps} rightWrapperProps={rightWrapperProps} contentWrapperProps={contentWrapperProps} appLayerWrapperProps={appLayerWrapperProps} systemLayerWrapperProps={systemLayerWrapperProps} top={this.props.top === undefined ? <Top /> : this.props.top} bottom={this.props.bottom === undefined ? <Bottom /> : this.props.bottom} left={this.props.left} right={this.props.right} leftOpen={this.props.leftOpen} leftClosed={this.props.leftClosed} rightOpen={this.props.rightOpen} rightClosed={this.props.rightClosed} leftWidth={this.props.leftWidth} rightWidth={this.props.rightWidth} alertBus={this.props.alertBus === undefined ? <UU5.Bricks.AlertBus /> : this.props.alertBus} modal={this.props.modal === undefined ? <UU5.Bricks.Modal /> : this.props.modal} systemLayerContent={this.props.systemLayerContent === undefined ? [this._getLanguageSelector(), <Button />, <NotificationBadge />, <UU5.Bricks.ButtonToTop />] : this.props.systemLayerContent} appLayerContent={this.props.appLayerContent || this.props.userLayerContent}>
          {this.props.children}
        </UU5.Bricks.Page> : null;
  }
} //@@viewOff:render
