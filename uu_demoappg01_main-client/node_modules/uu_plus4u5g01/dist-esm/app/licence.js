...
export const Licence = createReactClass({
  ...
  _getRow(title, content) {
    return <UU5.Bricks.Div className={this.getClassName().row}>
  ...
  render() {
    ...
    return <UU5.Bricks.Section {...this.getMainPropsToPass()} content={null} header={header} level={this.props.level || 4}>
