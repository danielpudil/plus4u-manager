...
export const Authors = createReactClass({
  ...
  //@@viewOn:render
  render() {
    return <UU5.Bricks.Section {...this.getMainPropsToPass()} content={null} level={this.props.level || 3}>
        {this.props.leadingAuthors && <UU5.Bricks.Div className={this.getClassName().authors} content={this._getAuthors(this.props.leadingAuthors, 'm')} />}
        {this.props.otherAuthors && <UU5.Bricks.Div className={this.getClassName().authors} content={this._getAuthors(this.props.otherAuthors, 's')} />}
      </UU5.Bricks.Section>;
  }
  //@@viewOff:render
});
...
const Author = createReactClass({
  ...
  //@@viewOn:render
  render() {
    return <UU5.Bricks.Column {...this._getMainAttrs()}>
        <Plus4U5.Bricks.UserPhoto className={this.getClassName().image} type="circle" width={null} uuIdentity={this.props.uuIdentity} src={this.props.src} />

        {this.props.signature && <UU5.Bricks.Image className={this.getClassName().signature} src={this.props.signature} />}
