...
export const NavigationBar = createReactClass({
  ...
  //@@viewOn:mixins
  mixins: [UU5.Common.BaseMixin, UU5.Common.ElementaryMixin, UU5.Common.NestingLevelMixin, UU5.Common.PureRenderMixin, UU5.Common.IdentityMixin],
  //@@viewOff:mixins
  ...
  render() {
    ...
    if (this.getNestingLevel() && this.isAuthenticated()) {
      child = <NavigationBarLoader {...this.getMainPropsToPass()} mainEntityUri={this._fixUesUri(this.props.mainEntityUri)} navigationBarUri={this._fixUesUri(this.props.navigationBarUri)} target={this.props.target} uuIdentityName={this.getIdentity().name} ref_={loader => this._loader = loader} />;
    }
