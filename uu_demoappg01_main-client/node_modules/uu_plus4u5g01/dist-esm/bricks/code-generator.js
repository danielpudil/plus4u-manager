...
export const CodeGenerator = createReactClass({
  ...
  render: function () {
    ...
    return <UU5.Bricks.Button {...this.getMainPropsToPass()} onClick={this._copy} content={content} colorSchema={this.props.colorSchema} size={this.props.size} displayBlock={this.props.displayBlock} bgStyle={this.props.bgStyle} pressed={this.props.pressed}>
        {this.props.children}
      </UU5.Bricks.Button>;
  }
  //@@viewOff:render
