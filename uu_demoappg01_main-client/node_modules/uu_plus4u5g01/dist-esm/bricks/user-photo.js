...
export const UserPhoto = createReactClass({
  ...
  render() {
    ...
    return <RichImage {...props} name={this.props.uuIdentity} src={this._getUserPhoto(this.props.uuIdentity)} shape={this.props.type} effect="none" shadow={this.props.shadow} />;
  }
  //@@viewOff:render
});
