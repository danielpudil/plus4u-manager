...
export const CopyToClipboard = createReactClass({
  ...
  _getBasicButton() {
    return <UU5.Bricks.Button {...this._getMainProps()} onClick={(button, e) => {
  ...
  _getUrlButton() {
    ...
    switch (this.state.state) {
      case 'initial':
        buttonProps = {
          content: [<UU5.Bricks.Icon key="icon" icon="mdi-download" className={this.getClassName('icon')} />, this.props.initialContent || this.getChildren()],
          colorSchema: 'primary',
          onClick: (button, e) => {
      ...
      case 'loading':
        buttonProps = {
          content: [<UU5.Bricks.Icon key="icon" icon="mdi-refresh" className={this.getClassName('icon') + ' ' + this.getClassName('rotating')} />, this.props.loadingContent || this.getChildren()],
          colorSchema: 'primary'
        };
        break;
      case 'ready':
        buttonProps = {
          content: [<UU5.Bricks.Icon key="icon" icon="mdi-content-copy" className={this.getClassName('icon')} />, this.props.readyContent || this.getChildren()],
          colorSchema: 'success',
