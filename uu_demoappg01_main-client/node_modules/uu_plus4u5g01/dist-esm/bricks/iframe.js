  ...
  render() {
    ...
    switch (this.getLoadFeedback()) {
      case "loading":
        ...
        break;
      case "ready":
        child = <UU5.Bricks.Iframe {...this.getMainAttrs()} src={this.getDtoOut()} resize={this.props.resize} height={this.props.height} syncTimeout={this.props.syncTimeout} inline={this.props.inline} iframeAttrs={this.props.iframeAttrs} />;
        break;
      default:
        child = <UU5.Bricks.Error {...this.getMainPropsToPass()}>
