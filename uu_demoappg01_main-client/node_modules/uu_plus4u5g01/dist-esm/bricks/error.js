...
export const Error = createReactClass({
  ...
  render: function () {
    ...
    return <UU5.Bricks.Error {...props} silent={this.props.silent} errorData={this.props.errorData} inline={this.props.inline} error={this.props.error} moreInfo errorInfo={<div>
