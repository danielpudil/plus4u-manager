...
export let ImageLegacy = createReactClass({
  ...
  //@@viewOn:propTypes
  propTypes: {
    sheetUri: PropTypes.string.isRequired,
  ...
  _buildSrc() {
    ...
    return UU5.Common.Tools.formatString(this.getDefault().contentUrl, [this._getTerritoryCode(sheetUri), sheetUri, this.props.code, Plus4U5.Environment.getToken(), this.props.readOnly]);
  },
  ...
  render() {
    return <div {...this.getMainAttrs()}>
        <UU5.Bricks.Modal parent={this} header=" " ref_={modal => this._modal = modal} className={this.getClassName().modal} />
