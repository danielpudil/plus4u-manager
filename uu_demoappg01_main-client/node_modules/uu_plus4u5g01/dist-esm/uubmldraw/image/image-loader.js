...
export const ImageLoader = createReactClass({
  ...
  //@@viewOn:propTypes
  propTypes: {
    tidAwid: PropTypes.string.isRequired,
  ...
  //@@viewOn:render
  render() {
    return this.getLoadFeedbackChildren(() => <div {...this.getMainAttrs()} onMouseOver={() => this._onMouseOverHandler()} onMouseOut={() => this._onMouseOutHandler()}>
