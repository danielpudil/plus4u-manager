...
var plus4u5BaseUrl = uri ? uri.replace(/^(.*\/).*/, '$1') : './';

var Environment = {
  name: process.env.NAME,
  mode: process.env.NODE_ENV,
  version: process.env.VERSION,
  licence: 'uu_plus4u5g01-' + process.env.VERSION + ' ©Unicorn 2017',
  ...
  getToken: function getToken() {
    return UU5.Environment.getSession().getCallToken() ? UU5.Environment.getSession().getCallToken().token : null;
  }
};
...
UU5.Environment.setSession(_uu_oidcg.Session);
